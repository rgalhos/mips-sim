...
export const rvManual: IUserManual = {
  ...
  registers: [
    { name: 'x0', alias: 'zero', kind: 'constant', description: 'Hardwired zero (alias **zero**); reads always return 0.' },
    { name: 'x1', alias: 'ra', kind: 'link', description: 'Return address (alias **ra**); holds the link value for jal/jalr.' },
    { name: 'x2', alias: 'sp', kind: 'pointer', description: 'Stack pointer (alias **sp**); points to the current stack top.' },
    { name: 'x3', alias: 'gp', kind: 'pointer', description: 'Global pointer (alias **gp**); points near static data for efficient addressing.' },
    { name: 'x4', alias: 'tp', kind: 'pointer', description: 'Thread pointer (alias **tp**); TLS or runtime thread-local base.' },
    { name: 'x5', alias: 't0', kind: 'temporary', description: 'Temporary (alias **t0**); caller-saved scratch.' },
    { name: 'x6', alias: 't1', kind: 'temporary', description: 'Temporary (alias **t1**); caller-saved scratch.' },
    { name: 'x7', alias: 't2', kind: 'temporary', description: 'Temporary (alias **t2**); caller-saved scratch.' },
    { name: 'x8', alias: 's0', kind: 'saved', description: 'Saved register / frame pointer (alias **s0**); callee-saved.' },
    { name: 'x9', alias: 's1', kind: 'saved', description: 'Saved register (alias **s1**); callee-saved.' },
    { name: 'x10', alias: 'a0', kind: 'argument', description: 'Argument / return (alias **a0**); first argument or return value.' },
    { name: 'x11', alias: 'a1', kind: 'argument', description: 'Argument / return (alias **a1**); second argument or return value.' },
    { name: 'x12', alias: 'a2', kind: 'argument', description: 'Argument (alias **a2**); third argument.' },
    { name: 'x13', alias: 'a3', kind: 'argument', description: 'Argument (alias **a3**); fourth argument.' },
    { name: 'x14', alias: 'a4', kind: 'argument', description: 'Argument (alias **a4**); fifth argument.' },
    { name: 'x15', alias: 'a5', kind: 'argument', description: 'Argument (alias **a5**); sixth argument.' },
    { name: 'x16', alias: 'a6', kind: 'argument', description: 'Argument (alias **a6**); seventh argument.' },
    { name: 'x17', alias: 'a7', kind: 'argument', description: 'Argument (alias **a7**); eighth argument.' },
    { name: 'x18', alias: 's2', kind: 'saved', description: 'Saved register (alias **s2**); callee-saved.' },
    { name: 'x19', alias: 's3', kind: 'saved', description: 'Saved register (alias **s3**); callee-saved.' },
    { name: 'x20', alias: 's4', kind: 'saved', description: 'Saved register (alias **s4**); callee-saved.' },
    { name: 'x21', alias: 's5', kind: 'saved', description: 'Saved register (alias **s5**); callee-saved.' },
    { name: 'x22', alias: 's6', kind: 'saved', description: 'Saved register (alias **s6**); callee-saved.' },
    { name: 'x23', alias: 's7', kind: 'saved', description: 'Saved register (alias **s7**); callee-saved.' },
    { name: 'x24', alias: 's8', kind: 'saved', description: 'Saved register (alias **s8**); callee-saved.' },
    { name: 'x25', alias: 's9', kind: 'saved', description: 'Saved register (alias **s9**); callee-saved.' },
    { name: 'x26', alias: 's10', kind: 'saved', description: 'Saved register (alias **s10**); callee-saved.' },
    { name: 'x27', alias: 's11', kind: 'saved', description: 'Saved register (alias **s11**); callee-saved.' },
    { name: 'x28', alias: 't3', kind: 'temporary', description: 'Temporary (alias **t3**); caller-saved scratch.' },
    { name: 'x29', alias: 't4', kind: 'temporary', description: 'Temporary (alias **t4**); caller-saved scratch.' },
