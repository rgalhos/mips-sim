...
export const rvManual: IUserManual = {
  instructions: [
    ...
    { name: 'fmadd.s',   operation: '', usage: 'fd, fs1, fs2, fs3', description: '' },
    { name: 'fmsub.s',   operation: '', usage: 'fd, fs1, fs2, fs3', description: '' },
    { name: 'fnmsub.s',  operation: '', usage: 'fd, fs1, fs2, fs3', description: '' },
    { name: 'fnmadd.s',  operation: '', usage: 'fd, fs1, fs2, fs3', description: '' },
    { name: 'fadd.s',    operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fsub.s',    operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fmul.s',    operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fdiv.s',    operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fsqrt.s',   operation: '', usage: 'fd, fs1, fs2', description: '' },
    ...
    { name: 'fcvt.w.s',  operation: '', usage: 'rd, fs1', description: '' },
    { name: 'fcvt.wu.s', operation: '', usage: 'rd, fs1', description: '' },
    { name: 'fmv.x.w',   operation: '', usage: 'rd, fs1', description: '' },
    { name: 'feq.s',     operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'flt.s',     operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fle.s',     operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fclass.s',  operation: '', usage: 'fd, fs1, fs2', description: '' },
    { name: 'fcvt.s.w',  operation: '', usage: 'fd, rs1', description: '' },
    { name: 'fcvt.s.wu', operation: '', usage: 'fd, rs1', description: '' },
    ...
    { name: 'beqz', operation: 'if (rs1 == 0) pc += offset', usage: 'rs1, rs2, offset', description: '**(pseudoinstruction)** Branches if rs1 is zero.' },
    { name: 'bnez', operation: 'if (rs1 != 0) pc += offset', usage: 'rs1, rs2, offset', description: '**(pseudoinstruction)** Branches if rs1 is non-zero.' },
